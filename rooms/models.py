...
def room_image_upload_path(instance, filename):
    """Store uploaded images outside web root with UUID filename."""
    ext = os.path.splitext(filename)[1].lower()
    return f'room_images/{uuid.uuid4().hex}{ext}'
...
class Room(models.Model):
    ...
    # File upload security: ImageField with upload_to using UUID renaming
